...
public class MarsrutAdapter extends ArrayAdapter<String> {

    private ArrayList<String> objects1, objects2;
    Context context;

    public MarsrutAdapter(@NonNull Context context, @LayoutRes int resource, ArrayList<String> objects1, ArrayList<String> objects2) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(currenView == null)
        {
            currenView = inflater.inflate(R.layout.marsrut_listview_item, viewGroup, false);
