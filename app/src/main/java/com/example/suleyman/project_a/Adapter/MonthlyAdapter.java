...
public class MonthlyAdapter extends ArrayAdapter<Daily_R> {


    Context context;
    List<Daily_R> myList;

    public MonthlyAdapter(Context context, int resource, List<Daily_R> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            if ((context.getResources().getConfiguration().screenLayout &
                ...
                convertView = inflater.inflate(R.layout.new_dailylist_forxlarge, null);

            }
            else
            {
                convertView = inflater.inflate(R.layout.new_daily_list, null);
        ...
        {
            holder.txt2016.setBackgroundColor(Color.parseColor("#FF045801"));
            holder.txtdiff.setBackgroundColor(Color.parseColor("#FF045801"));
        }
        else if(Daily_R.getMakeGreen().equals("no1"))
        {
            holder.txt2016.setBackgroundColor(Color.TRANSPARENT);
            holder.txtdiff.setBackgroundColor(Color.TRANSPARENT);
        }
        else if(Daily_R.getMakeGreen().equals("ok2"))
        {
            holder.txt2017.setBackgroundColor(Color.parseColor("#FF045801"));
            holder.txtdiff.setBackgroundColor(Color.parseColor("#FF045801"));
        }
        ...
        else if(Daily_R.getMakeGreen().equals("koko"))
        {
            holder.txt2016.setBackgroundColor(Color.TRANSPARENT);
            holder.txt2017.setBackgroundColor(Color.TRANSPARENT);
        }
