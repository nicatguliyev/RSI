...
public class YukInfoAdapter extends ArrayAdapter<String> {

    private ArrayList<String> objects1, objects2;
    Context context;

    public YukInfoAdapter(@NonNull Context context, @LayoutRes int resource, ArrayList<String> objects1, ArrayList<String> objects2) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(currenView == null)
        {
            currenView = inflater.inflate(R.layout.yukinfo_listview_item, viewGroup, false);
